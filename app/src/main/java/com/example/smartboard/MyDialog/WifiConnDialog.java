...
import com.example.smartboard.Wifi.WifiConnectUtils;

import java.util.List;

/**
 * Created by 刘宸睿 on 2016/8/4.
 */
public class WifiConnDialog extends Dialog {
     ...
     */
    public WifiConnDialog(Context context, int theme, ListView mListView, int mPosition,
                          MyListViewAdapter mAdapter, ScanResult scanResult, List<ScanResult> mScanResultList,
